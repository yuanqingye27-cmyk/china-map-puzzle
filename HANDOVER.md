...
- **测试**：**16371 项全绿**（离线 2202 + 浏览器 14169）
...
| 测试 | **16371 项全绿**：离线 2202 / 城市回归 89 / 引擎 77 / 玩法模式 77 / 多地图冒烟 13926 |
...
node tools/e2e-test.js 2>&1 | tail -24                        # 全量，基线 16371，约 9 分钟
```
...
node tools/e2e-test.js 2>&1 | tail -24                  # 全量（16371，约 9 分钟）
