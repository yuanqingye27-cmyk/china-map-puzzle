...
- **测试**：**17148 项全绿**（离线 2202 + 浏览器 14946）
...
| 测试 | **17148 项全绿**：离线 2202 / 城市回归 89 / 引擎 86 / 玩法模式 77 / 多地图冒烟 14652 / 极小碎片拖拽 42 |
...
node tools/e2e-test.js 2>&1 | tail -24                        # 全量，基线 17148，约 10 分钟
```
...
node tools/e2e-test.js 2>&1 | tail -24                  # 全量（17148，约 10 分钟）
