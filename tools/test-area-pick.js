...
const SHOULD_BE_OTHER = [
  ...
  // ⑤ "某个具体对象"的面积 —— 雅安批次真实案例（一次误判了 4 个县）
  ['开采区', '雨城区现设砂石集中开采区1个，位于八步镇和望鱼镇的辖区范围内，面积为24.67平方千米，预测资源量为2.379亿立方米。'],
  ['工业园区', '其中万里工业园规划面积7.2平方公里，甘溪坝工业园规划面积6.8平方公里。'],
  ['村组', '它位于石棉县蟹螺乡江坝村四组，距离石棉县城18公里，面积24平方公里，海拔1450米。'],
  ['村', '红星村坐落于国道318线旁，面积59.6平方千米。'],
  // 其他常见误命中
