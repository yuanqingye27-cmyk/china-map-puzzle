...
'use strict';
/* =====================================================================
 * ⛔ 【已休眠 · 2026-09】这个脚本服务的是"API Key 路线"，而那条路线**实测拿不到边界数据**
 *    （`/v2/administrative` 只返回行政树与中心点）。现在项目的边界数据来自
 *    **天地图服务中心官方通道**，入口是 tools/tianditu-download.js，不需要 Key。
 *    保留本文件仅为记录当时的排查过程；不要再用它来判断"接入是否成功"。
 *
 * 天地图接入自检 · 拿到 Key 之后第一个该跑的命令（历史）
 * ---------------------------------------------------------------------
