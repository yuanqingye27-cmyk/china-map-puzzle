/* =====================================================================
 * 地图包 · maanshan · 资料与关卡【占位骨架，等待人工补全】
 * ---------------------------------------------------------------------
 * 路径：js/maps/china/anhui/maanshan.data.js
 * 生成：node tools/add-map.js --adcode=340500 --name=maanshan --parent=anhui
 *
 ...
 * 《maanshan.geo.js》的官方边界几何计算得出（球面多边形面积，与 d3.geoArea 同公式），
 * 与拼图所用边界严格同源、可复现；属"几何计算值"，不等于官方公布的统计口径面积。
 * 重新生成：node tools/area-from-geo.js --only=maanshan --write
...
(function (global) {
  ...
  const DISTRICTS = {
    "340503": {
      area: 188,  // [geo-area] 依官方边界几何计算（km²）
    ...
    "340506": {
      area: 389,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 博望区
    "340521": {
      area: 975,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 当涂县
  ...
  const LEVELS = [
    ...
    },
    {
      ...
      adcodes: [340521, 340522, 340523],
    },
  ];

  const MAP_DATA = (global.MAP_DATA = global.MAP_DATA || {});
  MAP_DATA['maanshan'] = { districts: DISTRICTS, levels: LEVELS };
})(window);
