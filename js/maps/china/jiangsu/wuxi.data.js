/* =====================================================================
 * 地图包 · wuxi · 资料与关卡【占位骨架，等待人工补全】
 * ---------------------------------------------------------------------
 * 路径：js/maps/china/jiangsu/wuxi.data.js
 * 生成：node tools/add-map.js --adcode=320200 --name=wuxi --parent=jiangsu
 *
 ...
 * 《wuxi.geo.js》的官方边界几何计算得出（球面多边形面积，与 d3.geoArea 同公式），
 * 与拼图所用边界严格同源、可复现；属"几何计算值"，不等于官方公布的统计口径面积。
 * 重新生成：node tools/area-from-geo.js --only=wuxi --write
...
(function (global) {
  ...
  const DISTRICTS = {
    "320205": {
      area: 400,  // [geo-area] 依官方边界几何计算（km²）
    ...
    "320213": {
      area: 72.2,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 梁溪区
    ...
    "320282": {
      area: 1970,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 宜兴市
  ...
  const LEVELS = [
    {
      ...
      adcodes: [320205, 320206, 320211, 320213, 320214],
    },
    {
      id: 'l2',
      name: '县级市',
      ...
      adcodes: [320281, 320282],
    },
  ];

  const MAP_DATA = (global.MAP_DATA = global.MAP_DATA || {});
  MAP_DATA['wuxi'] = { districts: DISTRICTS, levels: LEVELS };
})(window);
