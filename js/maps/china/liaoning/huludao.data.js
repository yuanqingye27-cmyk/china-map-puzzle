/* =====================================================================
 * 地图包 · huludao · 资料与关卡【占位骨架，等待人工补全】
 * ---------------------------------------------------------------------
 * 路径：js/maps/china/liaoning/huludao.data.js
 ...
 * 《huludao.geo.js》的官方边界几何计算得出（球面多边形面积，与 d3.geoArea 同公式），
 * 与拼图所用边界严格同源、可复现；属"几何计算值"，不等于官方公布的统计口径面积。
 * 重新生成：node tools/area-from-geo.js --only=huludao --write
...
(function (global) {
  ...
  const DISTRICTS = {
    "211402": {
      area: 1158,  // [geo-area] 依官方边界几何计算（km²）
    ...
    "211404": {
      area: 1006,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 南票区
    "211421": {
      area: 2782,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 绥中县
    "211422": {
      area: 3186,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 建昌县
  ...
  const LEVELS = [
    {
      ...
      adcodes: [211402, 211403, 211404, 211481],
    },
    {
      id: 'l2',
      name: '县',
      ...
      adcodes: [211421, 211422],
    },
  ];

  const MAP_DATA = (global.MAP_DATA = global.MAP_DATA || {});
  MAP_DATA['huludao'] = { districts: DISTRICTS, levels: LEVELS };
})(window);
