/* =====================================================================
 * 地图包 · yingkou · 资料与关卡【占位骨架，等待人工补全】
 * ---------------------------------------------------------------------
 * 路径：js/maps/china/liaoning/yingkou.data.js
 * 生成：node tools/add-map.js --adcode=210800 --name=yingkou --parent=liaoning
 *
 ...
 * 《yingkou.geo.js》的官方边界几何计算得出（球面多边形面积，与 d3.geoArea 同公式），
 * 与拼图所用边界严格同源、可复现；属"几何计算值"，不等于官方公布的统计口径面积。
 * 重新生成：node tools/area-from-geo.js --only=yingkou --write
...
(function (global) {
  ...
  const DISTRICTS = {
    "210802": {
      area: 85.2,  // [geo-area] 依官方边界几何计算（km²）
    ...
    "210804": {
      area: 272,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 鲅鱼圈区
    ...
    "210881": {
      area: 2927,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 盖州市
  ...
  const LEVELS = [
    {
      ...
      adcodes: [210802, 210803, 210804, 210811],
    },
    {
      id: 'l2',
      name: '县级市',
      ...
      adcodes: [210881, 210882],
    },
  ];

  const MAP_DATA = (global.MAP_DATA = global.MAP_DATA || {});
  MAP_DATA['yingkou'] = { districts: DISTRICTS, levels: LEVELS };
})(window);
