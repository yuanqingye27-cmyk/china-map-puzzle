/* =====================================================================
 * 地图包 · dandong · 资料与关卡【占位骨架，等待人工补全】
 * ---------------------------------------------------------------------
 * 路径：js/maps/china/liaoning/dandong.data.js
 ...
 * 《dandong.geo.js》的官方边界几何计算得出（球面多边形面积，与 d3.geoArea 同公式），
 * 与拼图所用边界严格同源、可复现；属"几何计算值"，不等于官方公布的统计口径面积。
 * 重新生成：node tools/area-from-geo.js --only=dandong --write
...
(function (global) {
  ...
  const DISTRICTS = {
    "210602": {
      area: 94.6,  // [geo-area] 依官方边界几何计算（km²）
    ...
    "210604": {
      area: 667,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 振安区
    "210624": {
      area: 6282,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 宽甸满族自治县
    ...
    "210682": {
      area: 5511,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 凤城市
  ...
  const LEVELS = [
    {
      ...
      adcodes: [210602, 210603, 210604, 210624],
    },
    {
      id: 'l2',
      name: '县级市',
      ...
      adcodes: [210681, 210682],
    },
  ];

  const MAP_DATA = (global.MAP_DATA = global.MAP_DATA || {});
  MAP_DATA['dandong'] = { districts: DISTRICTS, levels: LEVELS };
})(window);
