/* =====================================================================
 * 地图包 · shaoxing · 资料与关卡【占位骨架，等待人工补全】
 * ---------------------------------------------------------------------
 * 路径：js/maps/china/zhejiang/shaoxing.data.js
 * 生成：node tools/add-map.js --adcode=330600 --name=shaoxing --parent=zhejiang
 *
 ...
 * 《shaoxing.geo.js》的官方边界几何计算得出（球面多边形面积，与 d3.geoArea 同公式），
 * 与拼图所用边界严格同源、可复现；属"几何计算值"，不等于官方公布的统计口径面积。
 * 重新生成：node tools/area-from-geo.js --only=shaoxing --write
...
(function (global) {
  ...
  const DISTRICTS = {
    ...
    "330604": {
      area: 1364,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 上虞区
    ...
    "330681": {
      area: 2317,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 诸暨市
    "330683": {
      area: 1788,  // [geo-area] 依官方边界几何计算（km²）
      landmark: '📖 资料收录中，欢迎参与共建',
      tagline: '📖 资料收录中，欢迎参与共建',
      funFact: '📖 资料收录中，欢迎参与共建',
    }, // 嵊州市
  ...
  const LEVELS = [
    {
      ...
      adcodes: [330602, 330603, 330604, 330624],
    },
    {
      id: 'l2',
      name: '县级市',
      ...
      adcodes: [330681, 330683],
    },
  ];

  const MAP_DATA = (global.MAP_DATA = global.MAP_DATA || {});
  MAP_DATA['shaoxing'] = { districts: DISTRICTS, levels: LEVELS };
})(window);
