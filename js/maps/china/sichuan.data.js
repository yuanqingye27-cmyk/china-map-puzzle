  ...
  const LEVELS = [
    {
      ...
      short: '地级市',
      color: '#3939d0',
      blurb: '按行政类型自动分组：省内的各地级市（18 个）。想把相邻的区县编成一关，或凑成"中心城区""沿江城市带"这类主题，直接改这个文件里的 levels。',
      adcodes: [510100, 510300, 510400, 510500, 510600, 510700, 510800, 510900, 511000, 511100, 511300, 511400, 511500, 511600, 511700, 511800, 511900, 512000],
    },
    {
      id: 'l2',
      name: '自治州与地区',
